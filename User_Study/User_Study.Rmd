...
----------------------------------------------------------------------------------------------------------
Neither likeness nor musical background play a role in listeners perception of Arousal and Valence overall
                        is confirmed for the withing song evaluation (as p > .01)
----------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------
    There is a positive relationship between both dimensions. Still, the correlation is low (r=0.25)
----------------------------------------------------------------------------------------------------------
...
positive_list <- c("Amazement", "Joy", "Sensuality", "TenderLonging", "Tranquility")
...
```{r ML_dimensions_positive:emotions}
negative_new_list <- c("Activation", "Dysphoria", "Sadness", "Power", "Transcendence")
